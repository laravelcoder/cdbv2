...
namespace PHPSTORM_META {
    ...
    * Generated on 2018-12-13 00:48:21.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'Spatie\UptimeMonitor\Helpers\UptimeResponseCheckers\UptimeResponseChecker' => \Spatie\UptimeMonitor\Helpers\UptimeResponseCheckers\LookForStringChecker::class,
        ...
        'command.monitor:check-certificate' => \Spatie\UptimeMonitor\Commands\CheckCertificates::class,
        'command.monitor:check-uptime' => \Spatie\UptimeMonitor\Commands\CheckUptime::class,
        'command.monitor:create' => \Spatie\UptimeMonitor\Commands\CreateMonitor::class,
        'command.monitor:delete' => \Spatie\UptimeMonitor\Commands\DeleteMonitor::class,
        'command.monitor:disable' => \Spatie\UptimeMonitor\Commands\DisableMonitor::class,
        'command.monitor:enable' => \Spatie\UptimeMonitor\Commands\EnableMonitor::class,
        'command.monitor:list' => \Spatie\UptimeMonitor\Commands\ListMonitors::class,
        'command.monitor:sync-file' => \Spatie\UptimeMonitor\Commands\SyncFile::class,
