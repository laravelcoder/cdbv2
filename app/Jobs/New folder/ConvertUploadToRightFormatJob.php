...
class ConvertUploadToRightFormatJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $checkfile = FFMpeg::fromDisk('videos')->open($this->video);
        ...
        // FFMpeg::fromDisk('videos')->open($this->video)
        ...
        //     ->save(public_path('uploads/clips/') . $clipid . "/" . $slug . '.mp4');

        // update the database so we know the convertion is done!
        // $this->video->update([
        //     'converted_for_downloading_at' => Carbon::now(),
        // ]);
        Log::info("ConvertUploadToRightFormatJob");
    }
}
